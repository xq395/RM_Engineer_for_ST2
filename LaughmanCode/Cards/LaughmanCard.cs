    ...
    CustomCardModel(cost, type, rarity, target)
{
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips => Id.Entry.RemovePrefix() switch
    {
        ...
        "ALL_NIGHTER_TUNING" => new[] { LaughmanHoverTips.Term("ROBOT"), LaughmanHoverTips.Term("BORROW") },
        "TACTICAL_TIMEOUT" => new[] { LaughmanHoverTips.Term("ROBOT"), LaughmanHoverTips.PlatedArmor() },
