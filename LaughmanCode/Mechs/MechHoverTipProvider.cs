...
public static class MechHoverTipProvider
{
    public static IHoverTip GetActionTip(MechModel mech)
    {
        string entry = mech switch
        {
            ...
            HeroMech hero when hero.TidalMode => "LAUGHMAN-HERO_MECH.tidalAction",
            HeroMech => "LAUGHMAN-HERO_MECH.action",
            EngineerMech engineer when engineer.MaxActions > 6 => "LAUGHMAN-ENGINEER_MECH.upgradedAction",
